...
from tkinter import VERTICAL, Frame, Label, Listbox, YES, BOTH, RAISED, FLAT, FALSE, X, Y, LEFT, Scrollbar
...
class MultiListbox(Frame, Observable):
    def __init__(self, master, lists):
        ...
        for label, width in lists:
            ...
            Label(frame, text=label, borderwidth=1, relief=RAISED).pack(fill=X)
    ...
    def get(self, first, last=None):
        ...
        for i in self.lists:
            result.append(i.get(first, last))
