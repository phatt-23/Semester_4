...
class EmailCardList(Component):
    ...
    def __init__(self, parent: Misc):
        ...
        self.list_frame = Component(self, label="list_frame")
        self.list_frame.pack(fill="both", expand=True, padx=(10, 10), pady=10)
        ...
        self.list_canvas = tk.Canvas(
            ...
            border=CANVAS_BORDER_SIZE,
            relief="groove",
            highlightthickness=0
        )
        self.list_canvas.pack(side="left", fill="both", expand=True, padx=(2,2), pady=10)

        # display frame inside canvas holding the cards (need not to be packed)
        self.cards_frame = Component(self.list_canvas, label="cards_frame")
    ...
    def _update_scrollbar_visibility(self, enable: bool):
        if enable:
            self.canvas_scrollbar.pack(side="right", fill="y", padx=(0, 2), pady=10)
        else:
    ...
    def _resize_frame(self):
        ...
        self.list_canvas.itemconfig(
            ...
            width=self.list_canvas.winfo_width() - 2*CANVAS_BORDER_SIZE,
            height=height, 
        )
